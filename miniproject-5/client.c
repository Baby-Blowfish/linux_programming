...
extern int send_chat_message(SOCKET sock, const char *username, const char * message, int max_retries);
extern int recv_chat_message(SOCKET sock, Message *msg, int max_retries);
