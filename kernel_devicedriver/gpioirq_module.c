...
#define GPIO_MINOR        1    // Minor number for the device
#define GPIO_DEVICE       "gpioledswirq" // Device name
#define GPIO_LED		  589    // GPIO pin number for LED (Pin 18)   "cat /sys/kernel/debug/gpio"
#define GPIO_SW			  594    // GPIO pin number for SW  (Pin 23)   "cat /sys/kernel/debug/gpio"
